...
const adm3File = 'geoBoundaries-IND-ADM3_simplified.geojson'; // Treat as GeoJSON
...
function processFeature(childFeature, index) {
  ...
  if (matchedState) {
    const adm2Candidates = adm2ByState.get(matchedState) || [];
...
const first5 = adm3Data.features.slice(0, 20);
